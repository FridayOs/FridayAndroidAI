...
private const val WELCOME_BODY =
    "FRIDAY AI runs the AI on your phone. The model, your chats, your documents, your " +
...
private val SECTIONS = listOf(
    ...
    DevNotesSection(
        ...
        body = "Open Plugins from the drawer to browse the public catalog on HuggingFace. Tap " +
                "Install, the zip downloads and runs inside FRIDAY AI with its own screen and " +
