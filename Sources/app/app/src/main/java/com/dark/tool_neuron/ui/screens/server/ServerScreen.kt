    ...
    StandardCard(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(dimens.spacingSm)) {
            ...
            UrlRow(
                ...
                url = deviceApiUrl,
                onCopy = { SecureClipboard.copy(ctx, "FRIDAY AI API URL", deviceApiUrl) },
            )
            UrlRow(
                label = "Web UI",
                url = deviceWebUrl,
                onCopy = { SecureClipboard.copy(ctx, "FRIDAY AI Web UI", deviceWebUrl) },
            )
            ActionTextButton(
                onClickListener = {
            ...
            if (lanWebUrl != null && lanApiUrl != null) {
                ...
                UrlRow(
                    label = "OpenAI base URL",
                    url = lanApiUrl,
                    onCopy = { SecureClipboard.copy(ctx, "FRIDAY AI LAN API URL", lanApiUrl) },
                )
                UrlRow(
                    label = "Web UI",
                    url = lanWebUrl,
                    onCopy = { SecureClipboard.copy(ctx, "FRIDAY AI LAN Web UI", lanWebUrl) },
                )
            }
        ...
        Column(verticalArrangement = Arrangement.spacedBy(dimens.spacingSm)) {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(dimens.spacingXs)) {
                if (visible) {
                    ...
                    ActionTextButton(
                        onClickListener = {
                            SecureClipboard.copy(ctx, "FRIDAY AI token", realToken)
                        },
                        icon = TnIcons.Copy,
                        text = "Copy",
                    )
