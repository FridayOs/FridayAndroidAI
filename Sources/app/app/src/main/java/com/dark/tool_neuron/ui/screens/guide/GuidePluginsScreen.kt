...
fun GuidePluginsScreen(innerPadding: PaddingValues) {
    GuideDetailLayout(
        ...
        icon = TnIcons.Puzzle,
        lede = "Plugins are mini-apps that run inside FRIDAY AI. They get their own Compose screen, can store data in encrypted storage, and can ship their own ONNX models. Browse them from the in-app store; they download straight from a public HuggingFace repo.",
        steps = listOf(
            GuideStep(
